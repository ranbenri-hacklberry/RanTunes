...
import { ArrowRight, Upload, Loader2, HardDrive, Trash2, Play } from 'lucide-react';
        ...
        <div className="p-4">
            ...
            {isSpotifyConnected && (
                <div className="flex items-center gap-2 mb-4 p-2 bg-green-500/10 rounded-xl border border-green-500/20">
                    ...
                    <span className="text-green-400 text-sm font-medium">Spotify מחובר</span>
                </div>
            )}
            ...
            {isLoading && albums.length === 0 ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <span className="text-white/70 font-medium text-sm">הוסף אלבום</span>
                    </div>
            ...
            {albums.length === 0 && !isLoading && musicSource && (
                <div className="text-center text-white/50 py-10">
                    אין אלבומים עדיין. לחץ על "הוסף אלבום" כדי להתחיל.
                </div>
            )}
